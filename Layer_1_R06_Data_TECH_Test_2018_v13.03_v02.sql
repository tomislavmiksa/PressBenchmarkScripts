...
GO
	...
	begin
		...
		where  Technology  not in		('GSM 850','GSM 900','GSM 1800','GSM 1900','UMTS 850','UMTS 900','UMTS 1700','UMTS 1900','UMTS 2100','LTE E-UTRA 1','LTE E-UTRA 2','LTE E-UTRA 3','LTE E-UTRA 7','LTE E-UTRA 8','LTE E-UTRA 10', 'LTE E-UTRA 12','LTE E-UTRA 20', 'LTE E-UTRA 13','LTE E-UTRA 28','LTE E-UTRA 38', 'LTE E-UTRA 40','LTE E-UTRA 41','LTE E-UTRA 26', 'LTE E-UTRA 39','No service','Emergency calls only','Unknown', 'Status not available','WiFi')		
		if @Error<>0 
		begin
			select distinct 'Fehlende RAT' as Error,Technology  
			from vTechnologyDurationTest
			where  Technology  not in	('GSM 850','GSM 900','GSM 1800','GSM 1900','UMTS 850','UMTS 900','UMTS 1700','UMTS 1900','UMTS 2100','LTE E-UTRA 1','LTE E-UTRA 2','LTE E-UTRA 3','LTE E-UTRA 7','LTE E-UTRA 8','LTE E-UTRA 10', 'LTE E-UTRA 12', 'LTE E-UTRA 13','LTE E-UTRA 20', 'LTE E-UTRA 28','LTE E-UTRA 38', 'LTE E-UTRA 41', 'LTE E-UTRA 40', 'LTE E-UTRA 39','LTE E-UTRA 26','No service','Emergency calls only','Unknown', 'Status not available', 'WiFi')		
		...
		begin
			...
			select	
				...
				NULLIF (CAST([TIME_GSM_850]					AS Decimal (10,3)), 0)	AS TIME_GSM_850_s,
			...
			(
				SELECT 
					...
					SUM(CASE WHEN Technology LIKE 'GSM 850'					THEN  TechnologyDuration ELSE 0 END)/1000.0	 AS [TIME_GSM_850],
